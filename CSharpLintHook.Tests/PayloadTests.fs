...
[<InlineData("/repo/src/Foo.fs", true)>]
[<InlineData("/repo/src/Foo.FSI", true)>]
[<InlineData("/repo/src/Foo.fsx", true)>]
...
[<InlineData("dotnet build src/Foo.fs", true)>]
[<InlineData("dotnet fsi scripts/Foo.fsx", true)>]
[<InlineData("type C:\\src\\Foo.fsi", true)>]
